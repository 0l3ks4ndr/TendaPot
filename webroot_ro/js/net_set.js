...
function initWanEvent() {
	...
	$("#dns1").attr("data-options", '{"type":"ip","msg":"' + _("Please enter a correct primary DNS server.") + '"}');
	$("#dns2").attr("data-options", '{"type":"ip","msg":"' + _("Please enter a correct secondary DNS server.") + '"}');
}
