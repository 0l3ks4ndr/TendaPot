...
function initDoubleBand(en){
	...
	if(en == "0"){//双频合一关闭时   正常显示配置
		...
		var value_length = null == storageSSID24.match(/[^ -~]/g) ? storageSSID24.length : storageSSID24.length + storageSSID24.match(/[^ -~]/g).length * 2;
		$("#ssid_5g").val((value_length > 29 ? storageSSID24.slice(0, -3) : storageSSID24) + '_5G');
		//2.4G开关
