...
function drawList(dataList) {
	...
	for (i = 0; i < dataList.length; i++) {
		if (!dataList[i].exist) {
			...
			elem.find("[alt=limitDown] .dropdown-menu").css("left", $("#netBody tr:first").find("span[alt=limitDown]").width() - $("#netBody tr:first").find("[alt=limitDown] .dropdown-menu").width() + "px");
